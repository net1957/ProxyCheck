...
ProxyCheck is a Rails 8.1 application and all rails prerequisites applies.

Node.js, Yarn, Git and Ruby 4.0 or higher should be installed on the system.
...
You can use Vagrant to test it. A Vagrantfile based on debian-12 and ruby 4.0 is provided.
